        ...
        <p>
          <ul>
            <li>
              ...
              <br />
              The admin can view the stats such as sharp eye, focus, critical thinking of all players.
            </li>
            <li>
              <strong>Save and Continue game Feature</strong>
              <br />
              Any Player can quit the game and save their progress
            </li>
            <li>
              <strong> 5 Unique puzzles and 1 deadpoints</strong>
              <br />
