    ...
    <>
      <div className="gamebody">
        ...
        <div className="gamecontent">
          <p>
            I am a hero, with an armored suit,
            In battles I'm tough, and never mute,
            I'm a genius, inventor, and philanthropist too,
            My heart is the key, to all that I do,
            Who am I? Solve the riddle, it's not hard
          </p>
